          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3 rtl:space-x-reverse">
                <MapPin className="h-4 w-4 text-cafe-gold mt-1 flex-shrink-0" />
                <span className="text-cafe-cream text-sm">
                  {language === 'ar' ? contactInfo.addressAr : contactInfo.address}
                </span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                <Phone className="h-4 w-4 text-cafe-gold flex-shrink-0" />
                <a
              ...
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                <Coffee className="h-4 w-4 text-cafe-gold flex-shrink-0" />
                <span className="text-cafe-cream text-sm">
